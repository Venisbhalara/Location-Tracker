    ...
    <>
      ...
      <div className="min-h-screen overflow-x-hidden" style={{ background: "#0d0d17" }}>
        ...
        <div className="pointer-events-none fixed inset-0 overflow-hidden">
          <div className="absolute -top-40 -left-40 w-[600px] h-[600px] rounded-full opacity-30" style={{ background: "radial-gradient(circle, rgba(99,102,241,0.15) 0%, transparent 70%)" }} />
          <div className="absolute top-1/3 -right-60 w-[700px] h-[700px] rounded-full opacity-20" style={{ background: "radial-gradient(circle, rgba(168,85,247,0.15) 0%, transparent 70%)" }} />
          <div className="absolute bottom-0 left-1/3 w-[500px] h-[500px] rounded-full opacity-15" style={{ background: "radial-gradient(circle, rgba(34,211,238,0.1) 0%, transparent 70%)" }} />
        </div>

  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        ...
        />
        <div
          className="absolute top-1/3 -right-60 w-[700px] h-[700px] rounded-full opacity-20"
          style={{
            background:
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-4 pt-16 pb-20 sm:pt-24 sm:pb-28">
        ...
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-white leading-[1.08] tracking-tight mb-6 max-w-4xl">
          ...
          <span
            ...
            style={{
              backgroundImage:
                "linear-gradient(135deg, #a3a6ff 0%, #c180ff 50%, #7de9ff 100%)",
            }}
          >
            In Real Time
          </span>
        ...
        <p className="text-lg sm:text-xl text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          allow location access, see their live position instantly on your map.
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          {isAuthenticated ? (
            <Link
              to="/dashboard"
              className="nextrack-btn-primary text-base px-10 py-4"
            >
              Go to Dashboard →
            </Link>
          ) : (
            <>
              ...
              <Link
                to="/login"
                className="nextrack-btn-ghost text-base px-10 py-4"
              >
                Sign In
              </Link>
            </>
      ...
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        ...
        <div className="flex flex-col items-center text-center mb-10">
          ...
          <p className="text-slate-400 max-w-xl text-lg">
            Advanced tools for real-time location sharing — built with privacy
            at the core.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((f) => (
            ...
            >
              ...
              <div
                className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${f.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none`}
              />

              <div className="relative z-10">
                <div
                  className={`w-12 h-12 flex items-center justify-center rounded-xl border text-2xl mb-5 ${f.iconBg} shadow-inner transition-transform duration-300 group-hover:scale-110`}
                >
                  {f.icon}
                </div>
              ...
              {/* Bottom accent bar */}
              <div
                className={`absolute bottom-0 left-6 right-6 h-px bg-gradient-to-r ${f.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
              />
            </div>
          ))}
        </div>
      ...
      <section className="relative py-16 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <p className="text-slate-400 max-w-xl text-lg">
              No app installation needed. No complicated setup. Just seamless,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-4 relative">
            ...
            <div
              className="hidden lg:block absolute top-16 left-[calc(33.33%+8px)] right-[calc(33.33%+8px)] h-px z-0"
              style={{
                background:
                  "linear-gradient(90deg, rgba(99,102,241,0.5), rgba(168,85,247,0.5), rgba(34,211,238,0.5))",
              }}
            />
            ...
            {steps.map((s, i) => (
              <div
                key={s.num}
                className={`relative group z-10 ${i === 1 ? "lg:mt-10" : ""}`}
              >
                <div
                  className={`relative rounded-3xl p-8 h-full border border-white/[0.07] backdrop-blur-sm transition-all duration-500 ${s.hoverBorder} ${s.hoverShadow} hover:-translate-y-1.5`}
                  style={{ background: "rgba(255,255,255,0.025)" }}
                >
                  {/* Hover overlay */}
                  <div
                    className={`absolute inset-0 rounded-3xl bg-gradient-to-br ${s.overlayColor} to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none`}
                  />
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex items-center justify-between mb-7">
                      <div
                        className={`w-14 h-14 flex items-center justify-center rounded-2xl border text-2xl ${s.iconBg} transition-transform duration-300 group-hover:scale-110`}
                      >
                        {s.icon}
                      </div>
                      <span
                    ...
                    {/* Bottom accent line */}
                    <div
                      className={`mt-7 h-0.5 w-10 rounded-full bg-gradient-to-r ${s.accentFrom} ${s.accentTo} group-hover:w-20 transition-all duration-500`}
                    />
                  </div>
                </div>
              </div>
      ...
      <section className="relative px-4 pb-16">
        <div className="max-w-4xl mx-auto">
          {/* Glass card */}
          <div
            className="relative rounded-3xl overflow-hidden border border-white/[0.08] p-1"
            style={{
              background:
                "linear-gradient(135deg, rgba(99,102,241,0.15), rgba(168,85,247,0.1), rgba(34,211,238,0.08))",
            }}
          >
            <div
              className="rounded-[22px] p-10 text-center relative overflow-hidden"
              style={{
            ...
            >
              {/* Inner orb */}
              <div
                className="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 w-[400px] h-40 rounded-full opacity-30"
                style={{
                  background:
              ...
              <div className="relative z-10">
                ...
                {isAuthenticated ? (
                  <Link
                    to="/dashboard"
                    className="nextrack-btn-primary text-base px-12 py-4 inline-flex"
                  >
                    Open Dashboard →
                  </Link>
                ) : (
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link
                      to="/register"
                      className="nextrack-btn-primary text-base px-12 py-4"
                    >
                      Start Tracking Free
                    </Link>
                    <Link
